...
class CheckListCustomSuite():
    ...
    def __init__(self, model_pipe) -> None:
        ...
        Args:
            model_pipe (_type_): A function that given a string input returns model predictions in shape [{'label': 'LABEL_1', 'score': 0.9622157216072083}]. For example a Huggingface transformers pipeline. 
        """
    ...
    def testsuite(self, templates:List, entity_fillins:Dict, true_label:int, editor=Editor(),
        ...
        Args:
            ...
            round_decimals (int, optional): Number of decimals model predictions are rounded to if round_preds is True. Defaults to 4.
    ...
    def _pred_and_conf_binary(self, data):
        ...
        Args:
            data (str or list[str]): Sentence or sentences to classify. Input to model.
