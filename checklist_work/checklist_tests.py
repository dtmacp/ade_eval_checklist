...
from templates_creator import TempOrderTemplates, PosSentimentTemplates, NegationTemplates
...
def get_template_sample(template_dict, n):
    ...
    Used to reduce the number of templates while keeping a variety for all types of capabilities except beneficial effects.. 
...
if __name__== "__main__":
    ...
    parser.add_argument(
        '--model', type=str, 
        default="../model/saved_models/bioredditbert_finetuned_batchsample",
